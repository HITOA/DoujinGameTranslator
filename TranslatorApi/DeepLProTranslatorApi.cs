...
{
    internal class DeepLProTranslatorApi : ITranslatorApi
    {
        private const string path = "https://api.deepl.com/v2/translate";
        private const string authPath = "https://api.deepl.com/v2/usage";
        ...
        public DeepLProTranslatorApi(string apikey)
        {
            key = apikey;
